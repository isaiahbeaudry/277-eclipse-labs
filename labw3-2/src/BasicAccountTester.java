...
//An BasicAccount with initial balance of 100.00 BankAccount account = new BasicAccount(100.00); System.out.println(account.getBalance()); System.out.println("Expected: 100.0");
		/*
		 * withdraw - If the amount is larger than the balance, the withdraw request
		 * will be denied
		 */
