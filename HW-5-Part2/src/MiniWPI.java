...
public interface MiniWPI {
	...
	/**
	 * Stack of Characters to the left of the cursor; the ones near the top of the
	 * stack are closest to the cursor.
	 */
	public static final Stack<Character> left = new Stack<Character>();

	/**
	 * Stack of Characters to the right of the cursor; the ones near the top of the
	 * stack are closest to the cursor.
	 */
